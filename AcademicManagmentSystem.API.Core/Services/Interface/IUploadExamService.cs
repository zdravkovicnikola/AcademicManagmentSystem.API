...
namespace AcademicManagmentSystem.API.Core.Services.Interface
{
    ...
    {
        public Task ProcessOrUpdatePrakticniRecord(BasicDTO record, bool isUpdate, int predmetId);
        public Task ProcessOrUpdateUsmeniRecord(BasicDTO record, bool isUpdate, int predmetid);
    }
}
